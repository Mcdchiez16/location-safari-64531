  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">About Ticlapay</h1>
        ...
        <Card className="p-8 mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Ticlapay is a leading fintech company specializing in cross-border money transfers between Zimbabwe and Zambia.
