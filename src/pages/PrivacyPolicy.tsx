      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <Card className="p-8 mb-6">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            At Tangila Pay, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, 
            and safeguard your information when you use our money transfer services.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            By using Tangila Pay, you agree to the collection and use of information in accordance with this policy.
          </p>
        </Card>
        ...
        <Card className="p-8 mb-6">
          ...
          <p className="text-muted-foreground mt-4">
            Email: privacy@tangilapay.com<br />
            Phone: +263 123 4567
          </p>
        </Card>
      </main>
