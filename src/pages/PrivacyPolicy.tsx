      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <Card className="p-8 mb-6">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            At Ticlapay, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, 
            and safeguard your information when you use our money transfer services.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            By using Ticlapay, you agree to the collection and use of information in accordance with this policy.
          </p>
        </Card>
