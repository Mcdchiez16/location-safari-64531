  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">Security at Tusapay</h1>
        ...
        <Card className="p-8 mb-8">
          ...
          <ul className="space-y-3">
            {[
              "Use a strong, unique password for your Tusapay account",
              ...
              "Be cautious of phishing emails claiming to be from Tusapay"
            ].map((tip, index) => (
